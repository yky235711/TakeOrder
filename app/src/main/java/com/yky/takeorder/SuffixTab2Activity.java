    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                String minusSuffix="--"+suffix.get(i);
                if(MainMenu.selectedSuffixList.contains(minusSuffix)){
                    MainMenu.selectedSuffixList.remove(minusSuffix);
                }else{
                    MainMenu.selectedSuffixList.add(minusSuffix);
                }
